"""
Restricted Boltzmann Machine (RBM) -- classical baseline for the Born Machine.

The RBM is trained via Contrastive Divergence (CD-k) and provides:
  - exact probability computation (brute-force, feasible for small n)
  - Gibbs-chain sampling
"""
