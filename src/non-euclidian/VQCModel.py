...
class VQCModel:
    """
    Central variational quantum circuit model for non-Euclidean data.

    Assembles a geometry-preserving embedding, a variational ansatz, and a
    measurement into a single PennyLane QNode.  Provides ``forward()`` for
    the Trainer and quantum dropout for regularisation.
    ...
    embedding : EmbeddingLayer
        Configured embedding strategy (spherical / cyclical / angle / amplitude).
    ansatz : AnsatzLayer
